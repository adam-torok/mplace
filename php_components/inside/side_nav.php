<div class="h-full pr-4 pt-8 w-64 fixed mt-8 w-0 md:w-1/4 lg:w-1/5 h-0 overflow-y-hidden bg-white">
      <div class="w-full h-full pr-4 px-2 text-gray-900 bg-white shadow-lg text-left capitalize font-medium">
