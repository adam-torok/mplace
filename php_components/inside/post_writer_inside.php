...
<form id="post-writer" method="POST">
    <div class="card bg-white w-full shadow-lg rounded-lg p-5">
      <textarea name="post-text" id="post-text" class="bg-white w-full rounded-lg border p-2" rows="5" placeholder="Oszd meg gondolataidat <?php echo $_SESSION['uLN']?>!"></textarea>
