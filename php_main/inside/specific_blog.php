...
<html lang="en" dir="ltr">
  ...
  <body oncontextmenu="return false">
    ...
    <div style="margin-left:20%" class="flex max-w-full pt-20 p-5 justify-center">
    <?php include_once("../../php_components/inside/specific_blog_inside.php");?>
    </div>
  </body>
